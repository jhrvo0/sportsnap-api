...
public class PerfilServico {
    ...
    public Perfil editar(PerfilId id, AtletaId solicitanteId, String nomeExibicao,
                         String bio, String esporte, String localidade,
                         Visibilidade visibilidade, String fotoPerfil) {
        ...
        if (visibilidade != null) perfil.setVisibilidade(visibilidade);
        if (fotoPerfil != null)   perfil.setFotoPerfil(fotoPerfil);
