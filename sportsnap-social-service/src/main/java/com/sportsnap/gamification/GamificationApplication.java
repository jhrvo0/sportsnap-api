...
public class GamificationApplication {
    ...
    @Bean
    public com.sportsnap.gamification.dominio.post.PostEsportivoServico postEsportivoServico(
            com.sportsnap.gamification.dominio.post.PostEsportivoRepositorio repositorio,
            FeedServico feedServico) {
        return new com.sportsnap.gamification.dominio.post.PostEsportivoServico(repositorio, feedServico);
    }

    @Bean
    public com.sportsnap.gamification.dominio.comentario.ComentarioServico comentarioServico(
            com.sportsnap.gamification.dominio.comentario.ComentarioRepositorio repositorio) {
        return new com.sportsnap.gamification.dominio.comentario.ComentarioServico(repositorio);
    }
}
