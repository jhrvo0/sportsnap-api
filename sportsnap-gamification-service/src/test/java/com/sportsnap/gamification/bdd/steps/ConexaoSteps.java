...
public class ConexaoSteps {
    ...
    public void aprovarPedido(Integer alvoId, Integer solicitanteId) {
        var pedido = pedidoRepositorio.listarPendentesPorAlvo(idPerfil(alvoId)).get(0);
    ...
    public void deixarDeSeguir(Integer seguidorId, Integer seguidoId) {
        conexaoServico.deixarDeSeguir(idPerfil(seguidorId), idPerfil(seguidoId));
    }
    ...
    public void existeConexao(Integer seguidorId, Integer seguidoId) {
        assertTrue(conexaoRepositorio.obterPorPar(idPerfil(seguidorId), idPerfil(seguidoId)).isPresent());
    }
    ...
    public void naoExisteConexao(Integer seguidorId, Integer seguidoId) {
        assertTrue(conexaoRepositorio.obterPorPar(idPerfil(seguidorId), idPerfil(seguidoId)).isEmpty());
    }
    ...
    public void existePedidoPendente(Integer solicitanteId, Integer alvoId) {
        assertTrue(pedidoRepositorio.obterPendentePorPar(idPerfil(solicitanteId), idPerfil(alvoId)).isPresent());
    }
    ...
    public void naoExistePedidoPendente(Integer solicitanteId, Integer alvoId) {
        assertTrue(pedidoRepositorio.obterPendentePorPar(idPerfil(solicitanteId), idPerfil(alvoId)).isEmpty());
    }
