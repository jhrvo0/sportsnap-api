...
public class Perfil {
    ...
    public Perfil(PerfilId id, AtletaId usuarioId, String nomeExibicao, TipoConta tipoConta,
                  ...
                  int totalSeguidores, int totalSeguindo) {
    ...
    public boolean isPublico() {
        return visibilidade == Visibilidade.PUBLICA;
    }
    ...
    public void decrementarSeguidores() {
        if (totalSeguidores > 0) this.totalSeguidores--;
    }

    public void incrementarSeguindo() {
        this.totalSeguindo++;
    }

    public void decrementarSeguindo() {
        if (totalSeguindo > 0) this.totalSeguindo--;
    }
