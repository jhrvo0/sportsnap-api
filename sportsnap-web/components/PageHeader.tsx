...
/**
 * Cabeçalho de página hero. Raio unificado com o restante do app.
 * API (title/subtitle/eyebrow/children) preservada.
 */
export function PageHeader({ title, subtitle, eyebrow, children }: Props) {
  return (
    <section
      className="relative mb-10 overflow-hidden rounded-3xl px-6 py-12 fade-up sm:px-12 sm:py-16"
      style={{
    ...
    >
      ...
      <div className="relative flex flex-col justify-between gap-8 md:flex-row md:items-end">
        <div className="max-w-2xl">
          ...
          {subtitle && (
            <p className="mt-5 max-w-xl text-base font-medium leading-relaxed text-ink-300 sm:text-lg">
              {subtitle}
            </p>
          )}
        </div>
